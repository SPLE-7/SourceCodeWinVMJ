...
public class PeminjamanBukuFactory{
    private static final Logger LOGGER = Logger.getLogger(PeminjamanBukuFactory.class.getName());

    public PeminjamanBukuFactory()
    {

    }

    public static PeminjamanBuku createPeminjamanBuku(String fullyQualifiedName, Object ... base)
    {
        PeminjamanBuku record = null;
        try {
            ...
            record = (PeminjamanBuku) constructor.newInstance(base);
        } 
